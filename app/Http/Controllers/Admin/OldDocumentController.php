...
class OldDocumentController extends DM_BaseController
{
    protected $service;
    protected $panel = 'Old Document';
    protected $base_route = 'admin.old-document';
    protected $view_path = 'admin.old-document';
