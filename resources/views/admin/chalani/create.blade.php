        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">नयाँ चलानी</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">नयाँ चलानी</h3>
            ...
            <form action="{{ route($_base_route.'.store') }}" method="POST" enctype='multipart/form-data'>
              ...
              <div class="card-body row">
                <div class="form-group col-3">
                  ...
                  <input type="text" class="form-control" id="chalani-no" name="chalani_no" value="{{ old('chalani_no', $data['chalani_no']) }}" placeholder="">
