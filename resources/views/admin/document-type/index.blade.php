  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>कागजातको प्रकार </h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">होम</a></li>
              <li class="breadcrumb-item active">कागजातको प्रकार सुची</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">कागजातको प्रकार सुची</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
<script type="text/javascript">
    $(document).ready(function() {
        $('.ward-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('admin.document-type.data') }}",
            columns: [
                {
                    data: null,
                    name: 'id',
