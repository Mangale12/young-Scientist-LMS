        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">नयाँ कागजातको प्रकार </li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">नयाँ कागजातको प्रकार </h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form  action="{{ route($_base_route.'.store') }}" method="POST" enctype='multipart/form-data'>
                ...
                <div class="card-body row">
                  <div class="form-group col-3">
                    <label for="exampleInputEmail1">कागजातको प्रकारको नाम *</label>
