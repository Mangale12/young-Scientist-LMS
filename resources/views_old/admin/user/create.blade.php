            ...
            <form action="{{ route($_base_route.'.store') }}" method="POST" enctype='multipart/form-data'>
              ...
              <div class="card-body row">
                ...
                <div class="form-group col-3">
                  ...
                  <input type="text" class="form-control" id="last-name" name="last_name" value="{{ old('last_name') }}" placeholder="" >
                ...
                <div class="form-group col-3">
                    <label for="phone">पासवर्ड *</label>
                    <input type="password" class="form-control" id="password" name="password" value="{{ old('password') }}" placeholder="">
                    @if($errors->has('password'))
                    <p id="password-error" class="help-block text-danger"><span>{{ $errors->first('password') }}</span></p>
                    @endif
                </div>
                <div class="form-group col-3">
                ...
                <div class="form-group col-3">
                  <label for="document-type-id">स्थिति *</label>
                  <select name="status_id" id="document-type-id" class="form-control">
