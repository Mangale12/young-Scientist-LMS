        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">नयाँ पुरानो कागजात</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">नयाँ पुरानो कागजात</h3>
              <h3 class="card-title ml-5 float-right">आजको मिति: {{ datenepUnicode(date('Y-m-d'), 'nepali') }}</h3>
              <h3 class="card-title mr-5 float-right">पछिल्लो चालानी नम्बर: </h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{ route($_base_route.'.store') }}" method="POST" enctype='multipart/form-data'>
              @csrf
              <input type="hidden" name="is_old" id="is-darta" value="1">
              ...
              <div class="card-body row">
                ...
                <div class="form-group col-3">
                    ...
                    <input type="text" class="form-control" id="darta-no" name="darta_no" value="{{ old('darta_no') }}" placeholder="">
